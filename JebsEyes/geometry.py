# # Geometry generation functions for Panda3D
...
# def sphere(radius=1,  color=(1,1,1,1)):
#     from panda3d.core import GeomNode, NodePath
#     from panda3d.core import LColor, GeomVertexFormat, GeomVertexData, Geom, GeomTriangles, GeomVertexWriter
#     from panda3d.core import GeomVertexReader, GeomVertexRewriter
#     from panda3d.core import GeomPoints, GeomLines, GeomVertexArrayFormat, GeomVertexArrayData
#     from panda3d.core import AmbientLight, DirectionalLight
#     # from panda3d.core import Sphere as PandaSphere
#     from direct.showbase.ShowBase import ShowBase
#     from panda3d.core import Material

#     from panda3d.core import NodePath
#     from panda3d.core import LColor
#     from panda3d.core import GeomSphere

#     np = NodePath("sphere")
#     from panda3d.core import GeoMipTerrain, TextureStage, Texture
#     from panda3d.core import LVector3

#     sphere_model = ShowBase().loader.loadModel("models/misc/sphere")
#     sphere_model.reparentTo(np)
#     sphere_model.setScale(radius)
#     sphere_model.setColor(*color)
#     return np
